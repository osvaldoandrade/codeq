...
- Outgoing webhooks include W3C trace context headers (`traceparent` / `tracestate`) only. The `baggage` header is explicitly excluded to prevent unintentional propagation of sensitive data to third-party endpoints.
